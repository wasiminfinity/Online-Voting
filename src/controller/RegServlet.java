	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(a>1950 && (b-a) >=18)
		{
			...
			{	
				...
				String sql = "insert into register(FIRST_NAME,MIDDLE_NAME,LAST_NAME, GENDER,CONTACT,EMAIL,ADDRESS, COUNTRY,STATE,AADHAR, ELECTION, PASSWORD,DOB,USERNAME,status) values('"+fn+"', '"+mn+"', '"+ln+"','"+gend+"','"+cont+"','"+email+"','"+add+"','"+country+"','"+state+"','"+aadhar+"', '"+election+"','"+pass+"', '"+dob+"', '"+username+"', '"+status+"')";
