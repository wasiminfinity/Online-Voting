...
.adsense_fh5co-team {
	...
	<div class="banner-bottom1">
		<div class="banner-bottom1-grids"></div>
		...
		<div class="container">
			<div class="wmuSlider example1">
				...
				<div class="video">
					...
					<iframe
						src="https://player.vimeo.com/video/61220793?color=ffffff&amp;title=0&amp;byline=0&amp;portrait=0"
				...
				<!-- <div class="upcoming">
					...
					<ul>
						<li><a href="#">Election of President of 2017.</a>
						<span>December 15, 2015</span></li>
						<li><a href="#">Election of Vise President of 2017.</a>
						<span>December 20, 2015</span></li>
	...
	<div class="footer-top">
		<div class="container">
			<div class="footer-grids">
				<figure class="effect-winston"> <!--	<img src="images/images.jpg" alt="" class="img-responsive one" />-->
				<figcaption>
				<h2>
					<b>Mahatma<span> Gandhi</span></b>
				</h2>
				...
				<figcaption>
				<h2>
					<b>Jawaharlal <span> Nehru</span></b>
				</h2>
				<p>Time is not measured by the passing of years.But by what one
					does,what one feels and what one achieves</p>

				</figcaption> </figure>
				<figure class="effect-winston"> <!--	<img src="images/5.jpg" alt="" class="img-responsive one" />-->
				<figcaption>
				<h2>
					<b>Subhas<span> Chandra Bose</span></b>
				</h2>
				<p>Nationalism is inspired by the highest ideals of the human
					race, Satyam(the Truth),Shivam(the God),Sundaram(the beautiful).</p>
	...
	{
		System.out.println("profile page exception");
		e.printStackTrace();
	}%>
